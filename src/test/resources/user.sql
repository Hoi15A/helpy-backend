...
insert into USER (email, biographie, birthdate, firstname, lastname, password, permission, plz, sex, status, WANTS_TO_HELP_ACTIVE) values ('spidey@email.com', 'bio', '1998-01-02', 'Peter', 'Parker', 'm1y9zQYlz', 2, '8404', 'M', 0, true);
...
insert into USER (email, biographie, birthdate, firstname, lastname, password, permission, plz, sex, status, WANTS_TO_HELP_ACTIVE) values ('geografie@email.com', 'bio', '2000-01-02', 'Egli', 'Hasler', 'm1y9zQYlz', 2, '8409', 'M', 0, true);
insert into USER (email, biographie, birthdate, firstname, lastname, password, permission, plz, sex, status, WANTS_TO_HELP_ACTIVE) values ('dallmayr@email.com', 'bio', '2000-01-02', 'alois', 'Dallmayr', 'm1y9zQYlz', 2, '8408', 'M', 0, true);
insert into USER (email, biographie, birthdate, firstname, lastname, password, permission, plz, sex, status, WANTS_TO_HELP_ACTIVE) values ('thor@email.com', 'bio', '2000-01-02', 'Thor', 'Odinson', 'm1y9zQYlz', 2, '8406', 'M', 0, true);
...
insert into USER (email, biographie, birthdate, firstname, lastname, password, permission, plz, sex, status, WANTS_TO_HELP_ACTIVE) values ('ahmed_miri@gmx.net', 'Ich heisse Ahmed und bin 17 Jahre alt und bin seit 2015 in der Schweiz und komme aus Afghanistan. Ich wohne in Winterthur und gehe im Moment in die 10. Klasse. Ich schaue gerne Fussball und spiele beim SC Veltheim in der U19 2. Mannschaft. Ich habe Probleme mit Schreiben und Lesen von wichtigen Papieren in der Schweiz und verstehe sie nicht alle.', '2003-01-05', 'Ahmed', 'Miri', '$2y$12$flo6RSkexyFIRdj5zQjry.kCE9bFR.xkCCfWf6zFD/bUU7ZnV7lHG', 2, '8406', 'M', 1, false); -- password123