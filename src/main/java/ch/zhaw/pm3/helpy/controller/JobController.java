...
public class JobController {
    ...
    /**
     * Takes a {@link Job} and updates the database entry with the same id.
     * The saved {@link Job} will be returned after the update.
     * @param job {@link Job}
     * @return ResponseEntity<Job>
     */
    ...
    /**
     * Takes a job id and returns the found {@link Job} object from the database.
     * @param id long
     * @return ResponseEntity<Job>
     */
    @GetMapping("id/{id}")
